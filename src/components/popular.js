    ...
    <div className="popular">
      ...
      <div className="popular-container">
        ...
        <div className="course_card">
          <img src={Popular_1} alt="Course Image" />
        ...
        <div className="course_card">
          <img src={Popular_2} alt="Course Image" />
        ...
        <div className="course_card">
          <img src={Popular_3} alt="Course Image" />
        ...
        <div className="course_card">
          <img src={Popular_4} alt="Course Image" />
        ...
        <div className="course_card">
          <img src={Popular_5} alt="Course Image" />
        ...
        <div className="course_card">
          <img src={Popular_6} alt="Course Image" />
        ...
        <div className="course_card">
          <img src={Popular_7} alt="Course Image" />
        ...
        <div className="course_card">
          <img src={Popular_8} alt="Course Image" />
